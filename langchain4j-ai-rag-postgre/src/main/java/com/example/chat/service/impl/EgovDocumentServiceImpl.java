    ...
    public CompletableFuture<Integer> loadDocumentsAsync() {
        ...
        return CompletableFuture.supplyAsync(() -> {
            try {
                ...
                log.info("총 {}개의 문서를 로드했습니다. (마크다운: {}개, PDF: {}개, DOCX: {}개, HWP: {}개)",
                        allDocuments.size(), markdownDocuments.size(), pdfDocuments.size(), docxDocuments.size(), hwpDocuments.size());
