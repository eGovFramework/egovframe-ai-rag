...
class EgovDocumentServiceImplUploadValidationTest {
    ...
    private final EgovDocumentServiceImpl service =
            // 인자 수는 EgovDocumentServiceImpl 생성자(리더 6 + 변환 3[PII 마스킹 포함] + writer
            // + vectorStore + stringRedisTemplate + executor = 13)와 일치.
            new EgovDocumentServiceImpl(null, null, null, null, null, null, null, null, null, null, null, null, null);
